...
//dynamic properties are deprecated in 8.2
...
abstract class Entity implements Serializable
{
    ...
    private $extendedPropertiesList = ['raw', 'lastParameters', 'snapshot', 'transient','attributes','stableHash'];
    ...
    {
        return self::getExtendedObjectVars($this);
    }

    public function __unserialize(array $data): void
    {
        foreach (array_keys(self::getExtendedObjectVars($this)) as $property) {
            $this->{$property} = $data[$property];
        }
        //normally ___wakeup will be ignored by direct unserialize() since __unserialize() exists
        $this->__wakeup();
    }
    ...
    public static function getExtendedObjectVars(Entity $context)
    {
        ...
        foreach ($context->extendedPropertiesList as $key) {
